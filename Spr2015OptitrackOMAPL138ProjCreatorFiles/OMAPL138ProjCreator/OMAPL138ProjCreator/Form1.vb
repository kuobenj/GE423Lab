...
NoError:
        ...
        PrintLine(1, "copy " & ProjectDirectory & "..\Spr2015OptitrackOMAPL138ProjCreatorFiles\*.cmd " & ProjectDirectory)
        PrintLine(1, "copy " & ProjectDirectory & "..\Spr2015OptitrackOMAPL138ProjCreatorFiles\DSPBIOS\PROJECTNAME.tcf " & Project_DSPBIOS_Dir & ProjectName & ".tcf")
        PrintLine(1, "copy " & ProjectDirectory & "..\Spr2015OptitrackOMAPL138ProjCreatorFiles\include\*.* " & Project_include_Dir)
        PrintLine(1, "copy " & ProjectDirectory & "..\Spr2015OptitrackOMAPL138ProjCreatorFiles\PRUcode\*.* " & Project_PRUcode_Dir)
        PrintLine(1, "copy " & ProjectDirectory & "..\Spr2015OptitrackOMAPL138ProjCreatorFiles\src\*.* " & Project_src_Dir)
        PrintLine(1, "move " & Project_src_Dir & "user_PROJECTNAME.c " & Project_src_Dir & "user_" & ProjectName & ".c")
        PrintLine(1, "copy " & ProjectDirectory & "..\Spr2015OptitrackOMAPL138ProjCreatorFiles\project\*.ccxml " & ProjectSubDirectory)
        PrintLine(1, "copy " & ProjectDirectory & "..\Spr2015OptitrackOMAPL138ProjCreatorFiles\project\.settings\*.* " & ProjectSub_settings_Dir)
        PrintLine(1, Drive)
