...
#define GET_VBDATA_FROM_LINUX (OUTGPIO01 & 0x00000004)

#define SET_VBDATA_TO_LINUX (SETGPIO01 = 0x00000008)
#define CLR_VBDATA_TO_LINUX (CLRGPIO01 = 0x00000008)
#define GET_VBDATA_TO_LINUX (OUTGPIO01 & 0x00000008)
...
#define GET_LINUX_BOOTED ((INGPIO67 & 0x00002000)>>13)

#define GET_DATAFORFILE_TO_LINUX ((INGPIO01 & 0x00100000)>>20)
