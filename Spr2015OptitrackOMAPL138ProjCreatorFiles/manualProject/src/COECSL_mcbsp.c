...
void SetRobotOutputs(float vref, float turn, float pwm3, float pwm4, float servo1, float servo2, float servo3, float servo4, float dac1, float dac2) {
	...
	// Saturate possible servo values
	servo1 = (servo1 > 255) ? 255 : servo1;
	servo1 = (servo1 < 0) ? 0 : servo1;
	servo2 = (servo2 > 255) ? 255 : servo2;
	servo2 = (servo2 < 0) ? 0 : servo2;
	servo3 = (servo3 > 255) ? 255 : servo3;
	servo3 = (servo3 < 0) ? 0 : servo3;
	servo4 = (servo4 > 255) ? 255 : servo4;
	servo4 = (servo4 < 0) ? 0 : servo4;
	...
	f28335TXData.data.PWM[3] = pwm4;
	f28335TXData.data.Servo[0] = servo1;
	f28335TXData.data.Servo[1] = servo2;
	f28335TXData.data.Servo[2] = servo3;
	f28335TXData.data.Servo[3] = servo4;
