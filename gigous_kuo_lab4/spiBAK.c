...
//			GpioDataRegs.GPACLEAR.bit.GPIO6 = 1;
		...
		case 8:
			...
			MCP23S08_READ = SpiaRegs.SPIRXBUF;
	...
	unsigned int GPPUvalue, unsigned int IOCONvalue, unsigned int OLATvalue)
{
	...
	//write to IODIR
	SpiaRegs.SPITXBUF = ((unsigned)0x40);//write
	SpiaRegs.SPITXBUF = ((unsigned)0x00);//IODIR register
	SpiaRegs.SPITXBUF = IODIRvalue;//send the value
	...
	//write to IPOL
	SpiaRegs.SPITXBUF = ((unsigned)0x40);//write
	SpiaRegs.SPITXBUF = ((unsigned)0x01);//IPOL register
	...
	//write to GPPU
	SpiaRegs.SPITXBUF = ((unsigned)0x40);//write
	SpiaRegs.SPITXBUF = ((unsigned)0x06);//GPPU register
	...
	//write to IOCON
	SpiaRegs.SPITXBUF = ((unsigned)0x40);//write
	SpiaRegs.SPITXBUF = ((unsigned)0x05);//IOCON register
	...
	SpiaRegs.SPITXBUF = OLATvalue;//send the value
