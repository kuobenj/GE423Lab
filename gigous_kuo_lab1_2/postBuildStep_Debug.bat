...
echo hex6x.exe %PROJECT_ROOT%\..\out2bootbin.cmd -o %PROJECT_ROOT%\..\gigous_kuo_lab1_2.bin %PROJECT_ROOT%\debug\gigous_kuo_lab1_2.out >> temp_postBuildStep_Debug.bat
