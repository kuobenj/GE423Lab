...
echo hex6x.exe %PROJECT_ROOT%\..\out2bootbin.cmd -o %PROJECT_ROOT%\..\Lab6F28335Project.bin %PROJECT_ROOT%\debug\Lab6F28335Project.out >> temp_postBuildStep_Debug.bat
